...
net = NeuralNet(
    ...
    conv1_num_filters=16, conv1_filter_size=(3, 3), pool1_ds=(2, 2),
    dropout1_p=0.1,
    conv2_num_filters=32, conv2_filter_size=(2, 2), pool2_ds=(2, 2),
    dropout2_p=0.2,
    ...
    regression=True,
    batch_iterator=FlipBatchIterator(batch_size=64),
    on_epoch_finished=[
